...
<!-- 상단 메뉴 부분 -->
<nav
	class="navbar navbar-expand-md bg-light navbar-light fixed-top shadow-lg">
	...
	<div class="collapse navbar-collapse" id="navMenu">
		<ul class="navbar-nav">
			<c:forEach items="${topmenu }" var="obj" varStatus="ob">
				<li class="nav-item"><a
					href="${root }board/main?board_inx=${obj.board_idx}"
					class="nav-link">${obj.board_name }</a></li>
			</c:forEach>
		</ul>
